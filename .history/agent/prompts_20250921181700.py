...
- place_order: Place order for the current design (Handles all post-processing internally)
- search_order: Search for previous orders by order ID

GUIDELINES:
- If user wants to proceed with the order, guide them to place an order
...
- If user is satisfied with the design, encourage them to proceed with ordering
...
Remember: Guide users to place an order."""
}

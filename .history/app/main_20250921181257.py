...
@app.websocket("/ws/{user_id}") # websocket communication.
            ...
            try:
                ...
                if message.get("type") == "ping":
                    ...
                    if event_result.get("should_trigger"):
                        ...
                        if prompt:
                            # Stream the response over socket... 
                            ...
                            try: 
                                ...
                                async for chunk in StreamingHandler.stream_agent_response(
                                    ...
                                    event_metadata={
                                        "triggered_by": event_result.get("event_type"),
                                        "priority": event_result.get("priority")
                                    }
                                ):
                                    if chunk["type"] == "token":
                                        # Send token chunk
                                        ...
                                        await websocket.send_text(json.dumps({
                                            ...
                                            await websocket.send_text(json.dumps({
                                                "type": "agent_complete",
                                                "content": chunk["content"],
                                                "session_context": chunk.get("session_context"),
                                                "metadata": chunk.get("metadata")
                                            }))
